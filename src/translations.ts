export const quoteTranslations: [string, string][] = [
  [
  ...
  [
    ...
    "Kämpfe gegen mein Flug-Pokémon!",
  ],
  [
  ...
  [
    ...
    "Versuch's gar nicht erst - der Sieg gehört mir. / Bereite dich schon mal auf eine Niederlage vor! / Siegen ist für Sieger.",
  ],
  [
...
export const typeTranslations: [string, string][] = [
  ["Water", "Wasser"],
  ["Dark", "Unlicht"],
  ["Grass", "Pflanze"],
  ["Fighting", "Kampf"],
